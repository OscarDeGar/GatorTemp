...
#ifndef MAVROS_MSGS__SRV__DETAIL__MESSAGE_INTERVAL__FUNCTIONS_H_
#define MAVROS_MSGS__SRV__DETAIL__MESSAGE_INTERVAL__FUNCTIONS_H_
...
/// Initialize srv/MessageInterval message.
/**
...
/// Finalize srv/MessageInterval message.
/**
...
/// Create srv/MessageInterval message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mavros_msgs__srv__MessageInterval_Request__init().
...
/// Destroy srv/MessageInterval message.
/**
 * It calls
 * mavros_msgs__srv__MessageInterval_Request__fini()
...
/// Initialize array of srv/MessageInterval messages.
/**
...
/// Finalize array of srv/MessageInterval messages.
/**
 * It calls
 * mavros_msgs__srv__MessageInterval_Request__fini()
...
/// Create array of srv/MessageInterval messages.
/**
 * It allocates the memory for the array and calls
 * mavros_msgs__srv__MessageInterval_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MessageInterval messages.
/**
 * It calls
 * mavros_msgs__srv__MessageInterval_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mavros_msgs__srv__MessageInterval_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It calls
 * mavros_msgs__srv__MessageInterval_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It allocates the memory for the array and calls
 * mavros_msgs__srv__MessageInterval_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It calls
 * mavros_msgs__srv__MessageInterval_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MAVROS_MSGS__SRV__DETAIL__MESSAGE_INTERVAL__FUNCTIONS_H_
