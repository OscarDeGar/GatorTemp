...
{
  mavros_msgs__msg__RTCM * msg = (mavros_msgs__msg__RTCM *)malloc(sizeof(mavros_msgs__msg__RTCM));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__RTCM__Sequence__init(mavros_msgs__msg__RTCM__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__RTCM *)calloc(size, sizeof(mavros_msgs__msg__RTCM));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__RTCM__Sequence * array = (mavros_msgs__msg__RTCM__Sequence *)malloc(sizeof(mavros_msgs__msg__RTCM__Sequence));
  if (!array) {
    return NULL;
  }
