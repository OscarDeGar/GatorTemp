...
{
  mavros_msgs__msg__WaypointReached * msg = (mavros_msgs__msg__WaypointReached *)malloc(sizeof(mavros_msgs__msg__WaypointReached));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__WaypointReached__Sequence__init(mavros_msgs__msg__WaypointReached__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__WaypointReached *)calloc(size, sizeof(mavros_msgs__msg__WaypointReached));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__WaypointReached__Sequence * array = (mavros_msgs__msg__WaypointReached__Sequence *)malloc(sizeof(mavros_msgs__msg__WaypointReached__Sequence));
  if (!array) {
    return NULL;
  }
