...
{
  mavros_msgs__msg__ManualControl * msg = (mavros_msgs__msg__ManualControl *)malloc(sizeof(mavros_msgs__msg__ManualControl));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__ManualControl__Sequence__init(mavros_msgs__msg__ManualControl__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__ManualControl *)calloc(size, sizeof(mavros_msgs__msg__ManualControl));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__ManualControl__Sequence * array = (mavros_msgs__msg__ManualControl__Sequence *)malloc(sizeof(mavros_msgs__msg__ManualControl__Sequence));
  if (!array) {
    return NULL;
  }
