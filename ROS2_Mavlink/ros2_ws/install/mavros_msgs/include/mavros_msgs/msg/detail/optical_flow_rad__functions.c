...
{
  mavros_msgs__msg__OpticalFlowRad * msg = (mavros_msgs__msg__OpticalFlowRad *)malloc(sizeof(mavros_msgs__msg__OpticalFlowRad));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__OpticalFlowRad__Sequence__init(mavros_msgs__msg__OpticalFlowRad__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__OpticalFlowRad *)calloc(size, sizeof(mavros_msgs__msg__OpticalFlowRad));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__OpticalFlowRad__Sequence * array = (mavros_msgs__msg__OpticalFlowRad__Sequence *)malloc(sizeof(mavros_msgs__msg__OpticalFlowRad__Sequence));
  if (!array) {
    return NULL;
  }
