...
#ifndef MAVROS_MSGS__MSG__DETAIL__CELLULAR_STATUS__FUNCTIONS_H_
#define MAVROS_MSGS__MSG__DETAIL__CELLULAR_STATUS__FUNCTIONS_H_
 ...
 * calls
 * mavros_msgs__msg__CellularStatus__init().
...
/**
 * It calls
 * mavros_msgs__msg__CellularStatus__fini()
 ...
 * mavros_msgs__msg__CellularStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mavros_msgs__msg__CellularStatus__Sequence__fini()
 * on the array,
...
#endif  // MAVROS_MSGS__MSG__DETAIL__CELLULAR_STATUS__FUNCTIONS_H_
