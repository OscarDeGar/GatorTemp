...
{
  mavros_msgs__msg__LogData * msg = (mavros_msgs__msg__LogData *)malloc(sizeof(mavros_msgs__msg__LogData));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__LogData__Sequence__init(mavros_msgs__msg__LogData__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__LogData *)calloc(size, sizeof(mavros_msgs__msg__LogData));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__LogData__Sequence * array = (mavros_msgs__msg__LogData__Sequence *)malloc(sizeof(mavros_msgs__msg__LogData__Sequence));
  if (!array) {
    return NULL;
  }
