...
{
  mavros_msgs__msg__Trajectory * msg = (mavros_msgs__msg__Trajectory *)malloc(sizeof(mavros_msgs__msg__Trajectory));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__Trajectory__Sequence__init(mavros_msgs__msg__Trajectory__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__Trajectory *)calloc(size, sizeof(mavros_msgs__msg__Trajectory));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__Trajectory__Sequence * array = (mavros_msgs__msg__Trajectory__Sequence *)malloc(sizeof(mavros_msgs__msg__Trajectory__Sequence));
  if (!array) {
    return NULL;
  }
