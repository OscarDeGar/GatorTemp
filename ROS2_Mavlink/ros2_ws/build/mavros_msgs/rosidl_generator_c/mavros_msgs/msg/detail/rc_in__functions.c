...
{
  mavros_msgs__msg__RCIn * msg = (mavros_msgs__msg__RCIn *)malloc(sizeof(mavros_msgs__msg__RCIn));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__RCIn__Sequence__init(mavros_msgs__msg__RCIn__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__RCIn *)calloc(size, sizeof(mavros_msgs__msg__RCIn));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__RCIn__Sequence * array = (mavros_msgs__msg__RCIn__Sequence *)malloc(sizeof(mavros_msgs__msg__RCIn__Sequence));
  if (!array) {
    return NULL;
  }
