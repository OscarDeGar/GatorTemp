...
{
  mavros_msgs__msg__RTKBaseline * msg = (mavros_msgs__msg__RTKBaseline *)malloc(sizeof(mavros_msgs__msg__RTKBaseline));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__RTKBaseline__Sequence__init(mavros_msgs__msg__RTKBaseline__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__RTKBaseline *)calloc(size, sizeof(mavros_msgs__msg__RTKBaseline));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__RTKBaseline__Sequence * array = (mavros_msgs__msg__RTKBaseline__Sequence *)malloc(sizeof(mavros_msgs__msg__RTKBaseline__Sequence));
  if (!array) {
    return NULL;
  }
