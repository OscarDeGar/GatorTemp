...
{
  mavros_msgs__msg__WheelOdomStamped * msg = (mavros_msgs__msg__WheelOdomStamped *)malloc(sizeof(mavros_msgs__msg__WheelOdomStamped));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__msg__WheelOdomStamped__Sequence__init(mavros_msgs__msg__WheelOdomStamped__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__msg__WheelOdomStamped *)calloc(size, sizeof(mavros_msgs__msg__WheelOdomStamped));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__msg__WheelOdomStamped__Sequence * array = (mavros_msgs__msg__WheelOdomStamped__Sequence *)malloc(sizeof(mavros_msgs__msg__WheelOdomStamped__Sequence));
  if (!array) {
    return NULL;
  }
