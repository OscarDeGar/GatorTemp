...
{
  mavros_msgs__srv__FileOpen_Request * msg = (mavros_msgs__srv__FileOpen_Request *)malloc(sizeof(mavros_msgs__srv__FileOpen_Request));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__srv__FileOpen_Request__Sequence__init(mavros_msgs__srv__FileOpen_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__srv__FileOpen_Request *)calloc(size, sizeof(mavros_msgs__srv__FileOpen_Request));
    if (!data) {
      return false;
    }
...
{
  mavros_msgs__srv__FileOpen_Request__Sequence * array = (mavros_msgs__srv__FileOpen_Request__Sequence *)malloc(sizeof(mavros_msgs__srv__FileOpen_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  mavros_msgs__srv__FileOpen_Response * msg = (mavros_msgs__srv__FileOpen_Response *)malloc(sizeof(mavros_msgs__srv__FileOpen_Response));
  if (!msg) {
    return NULL;
  }
...
mavros_msgs__srv__FileOpen_Response__Sequence__init(mavros_msgs__srv__FileOpen_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (mavros_msgs__srv__FileOpen_Response *)calloc(size, sizeof(mavros_msgs__srv__FileOpen_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  mavros_msgs__srv__FileOpen_Response__Sequence * array = (mavros_msgs__srv__FileOpen_Response__Sequence *)malloc(sizeof(mavros_msgs__srv__FileOpen_Response__Sequence));
  if (!array) {
    return NULL;
  }
