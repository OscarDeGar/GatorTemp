...
#ifndef MAVROS_MSGS__SRV__DETAIL__PARAM_SET_V2__FUNCTIONS_H_
#define MAVROS_MSGS__SRV__DETAIL__PARAM_SET_V2__FUNCTIONS_H_
...
/// Initialize srv/ParamSetV2 message.
/**
...
/// Finalize srv/ParamSetV2 message.
/**
...
/// Create srv/ParamSetV2 message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mavros_msgs__srv__ParamSetV2_Request__init().
...
/// Destroy srv/ParamSetV2 message.
/**
 * It calls
 * mavros_msgs__srv__ParamSetV2_Request__fini()
...
/// Initialize array of srv/ParamSetV2 messages.
/**
...
/// Finalize array of srv/ParamSetV2 messages.
/**
 * It calls
 * mavros_msgs__srv__ParamSetV2_Request__fini()
...
/// Create array of srv/ParamSetV2 messages.
/**
 * It allocates the memory for the array and calls
 * mavros_msgs__srv__ParamSetV2_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ParamSetV2 messages.
/**
 * It calls
 * mavros_msgs__srv__ParamSetV2_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mavros_msgs__srv__ParamSetV2_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It calls
 * mavros_msgs__srv__ParamSetV2_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It allocates the memory for the array and calls
 * mavros_msgs__srv__ParamSetV2_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It calls
 * mavros_msgs__srv__ParamSetV2_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MAVROS_MSGS__SRV__DETAIL__PARAM_SET_V2__FUNCTIONS_H_
