...
#ifndef MAVROS_MSGS__SRV__DETAIL__VEHICLE_INFO_GET__FUNCTIONS_H_
#define MAVROS_MSGS__SRV__DETAIL__VEHICLE_INFO_GET__FUNCTIONS_H_
...
/// Initialize srv/VehicleInfoGet message.
/**
...
/// Finalize srv/VehicleInfoGet message.
/**
...
/// Create srv/VehicleInfoGet message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mavros_msgs__srv__VehicleInfoGet_Request__init().
...
/// Destroy srv/VehicleInfoGet message.
/**
 * It calls
 * mavros_msgs__srv__VehicleInfoGet_Request__fini()
...
/// Initialize array of srv/VehicleInfoGet messages.
/**
...
/// Finalize array of srv/VehicleInfoGet messages.
/**
 * It calls
 * mavros_msgs__srv__VehicleInfoGet_Request__fini()
...
/// Create array of srv/VehicleInfoGet messages.
/**
 * It allocates the memory for the array and calls
 * mavros_msgs__srv__VehicleInfoGet_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/VehicleInfoGet messages.
/**
 * It calls
 * mavros_msgs__srv__VehicleInfoGet_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mavros_msgs__srv__VehicleInfoGet_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It calls
 * mavros_msgs__srv__VehicleInfoGet_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It allocates the memory for the array and calls
 * mavros_msgs__srv__VehicleInfoGet_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mavros_msgs
...
/**
 * It calls
 * mavros_msgs__srv__VehicleInfoGet_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MAVROS_MSGS__SRV__DETAIL__VEHICLE_INFO_GET__FUNCTIONS_H_
